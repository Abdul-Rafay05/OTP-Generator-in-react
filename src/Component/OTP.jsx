...
function Otp(props) {
  ...
  return (
    <>
      <div className="container flex flex-col justify-center items-center w-full h-screen gap-5 bg-gradient-to-r from-[#02ff02] to-[#003780]">
        <h1 className="uppercase text-3xl font-bold">{props.mainHead}</h1>
        <div className="otp_container text-5xl border-solid border-2 border-black tracking-[5px] font-bold px-10 py-5 rounded-lg">
          {OTP}
        </div>
        <button
